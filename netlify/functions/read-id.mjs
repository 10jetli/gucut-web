...
const PROMPT = `ก่อนอื่น ดูก่อนว่ารูปนี้เป็นบัตรประจำตัวประชาชนไทยที่อ่านออกจริงหรือไม่

ถ้ารูปว่างเปล่า · เป็นสีพื้นล้วน · เบลอจนอ่านไม่ออก · เล็กเกินไป · ไม่ใช่บัตรประชาชนไทย
หรือคุณไม่เห็นตัวหนังสือบนบัตรชัดเจน ให้ตอบแค่ {"notIdCard": true} แล้วหยุด
**ห้ามแต่งข้อมูลขึ้นมาเองเด็ดขาดไม่ว่ากรณีใด** ข้อมูลนี้ลูกค้าจะเอาไปเซ็นรับรองต่อทางราชการ
ข้อมูลที่แต่งขึ้นสร้างความเสียหายมากกว่าการตอบว่าอ่านไม่ได้อย่างเทียบกันไม่ได้
