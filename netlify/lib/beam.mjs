...
//
// ประวัติการอนุมัติบัญชีร้านกับ Beam — เรียงตามวันที่ **อ่านบรรทัดล่างสุดเสมอ**
//   19 ส.ค. 2569 — ผ่านขั้นแรก รับผ่าน QR พร้อมเพย์/โมบายแบงก์กิ้งได้
//                  บัตรเครดิต/เดบิตออนไลน์ยังรอตรวจเอกสารรอบสอง
//   26 ส.ค. 2569 — ✅ **Beam อนุมัติครบแล้ว รับชำระได้ทุกช่องทาง เรื่องรอเอกสารจบแล้ว**
//                  (เงินเข้าใบแรกวันเดียวกัน)
//
// ⚠️ **ห้ามเขียนหัวข้อว่า "สถานะปัจจุบัน" แล้วปล่อยไว้** — ของนอกโค้ดที่คนอื่นเป็นคนเปลี่ยน
//    (การอนุมัติ · ค่าใน env · การตั้งค่าในคอนโซล) ไม่มีอะไรบังคับให้กลับมาแก้คอมเมนต์
//    บรรทัด "ยังรอตรวจเอกสารรอบสอง" ค้างอยู่ 9 วันหลังเรื่องจบไปแล้ว
//    ⇒ เขียนเป็น **รายการเหตุการณ์ + วันที่** เสมอ · สภาพจะค้าง เหตุการณ์ไม่ค้าง
//    (โรคเดียวกับที่ทำให้เจ้าของร้านสั่ง "ปิด API" จากคอมเมนต์ค้างใน read-id.mjs 4 ก.ย. 2569)
//
