...
/* ⚠️ **รายการนี้จะกลายเป็นเท็จทันทีที่เราสร้างเส้นนั้นขึ้นมา** — ต้องตัดออกพร้อมกันเสมอ
    เจอของจริง 6 ก.ย. 2569: "สร้างใบเสนอราคา" ยังค้างอยู่ในรายการนี้หลังทำเสร็จไปแล้ว
    ⇒ เพิ่มฟังก์ชันเขียนตัวใหม่เมื่อไหร่ **ลบแถวของมันออกจากรายการนี้ในคอมมิตเดียวกัน**
    (คลาส stale-state — ดู [[new-platform-needs-repo-sweep]]) */
