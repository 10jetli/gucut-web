/* 📎 ตัวไล่ดึงสลิปใหม่ตามเวลา — ใบกระดาน t_mu2sow9d (15 ก.ย. 2569)
   ...
   📏 วัด 18 ก.ย. 2569 (สุ่ม 40 ใบจาก 373 ใบที่มีสลิปในคลัง): Facebook 24 · LINE OA 14 · POS หน้าร้าน 2 · **มาร์เก็ตเพลส 0**
      ⇒ สนับสนุนว่าสลิปมาจากช่องทางขายตรง แต่ **0 ในตัวอย่างไม่ใช่ 0 ในประชากร** [[sampling-is-not-proof]]
      ⇒ **ยังไม่กรองตามช่องทาง ไล่ทุกใบเหมือนเดิม** — กรองแล้วถ้าสมมติฐานผิด สลิปที่หลุดจะหายถาวรตอนปิดบัญชี
