...
export async function reorderPlan(o = {}) {
  ...
  return {
    ...
    returnsNote:
      "ยอดใช้คิดจากใบขาย **ยังไม่ได้หักของที่ลูกค้าคืน** ⇒ ตัวเลขความต้องการอาจสูงกว่าจริง " +
      "(90 วันล่าสุดมีใบคืน 45 ใบ · ฿26,399 — เล็กเมื่อเทียบยอดรวม แต่ยังไม่ได้ตรวจรายรหัส) " +
      "⇒ รหัสที่ลูกค้าคืนบ่อยเป็นพิเศษ อาจถูกสั่งเกิน",
    chainsNote:
