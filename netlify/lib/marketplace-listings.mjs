...
const UNRELIABLE = {
  // 🧪 ธงทดสอบรอบ 2 — ตรวจว่ากล่องแดงที่ย้ายขึ้นหัวจอแล้ว เห็นได้ตั้งแต่จอแรกโดยไม่ต้องเลื่อน
  gucut: "ทดสอบตำแหน่งกล่องเตือนรอบ 2 — ไม่ใช่ปัญหาจริง ปลดออกทันทีหลังตรวจเสร็จ",
