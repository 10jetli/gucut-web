...
const STATUS_UNRELIABLE =
  "กำลังตรวจว่ากระจกค้างสถานะเก่าหรือไม่ — " +
  "นับทั้งกระจก (ทั้งปี ไม่จำกัดช่วงวันที่) ได้ใบที่ยังไม่จบ 187 ใบ " +
  "แต่การ์ดหน้าแรก ZORT (ทั้งระบบเช่นกัน) รวมได้ 156 (ค้างชำระเงิน 24 + ค้างโอนสินค้า 132) " +
  "ยังไม่ตรงกัน · ตรวจเมื่อ 4 ก.ย. 2569 " +
  "⚠️ เลข 187 นี้คนละขอบเขตกับเลขบนแท็บ ซึ่งนับเฉพาะช่วงวันที่ที่เลือกอยู่ " +
  "· ระหว่างนี้อย่าใช้ตัวเลขบนแท็บตัดสินใจ";
