...
// ⚠️ ต้องตัดวงเล็บและเครื่องหมายทิ้งก่อนเทียบเสมอ
//    ในรายการเขียน "5800 (รุ่นใหม่ 2025)" แต่ชื่อสินค้าจริงเขียน "KingKong 5800 รุ่นใหม่ 2025"
//    เทียบดิบ ๆ จะไม่ตรง ⇒ **รุ่นที่ไม่ต้องขอทะเบียนกลายเป็น "ไม่รู้จักรุ่น"**
//    ซึ่งทำให้จอขึ้นเตือนผิดกับสินค้าที่เป็นจุดขายของร้าน (เจอจริง 2 ก.ย. 2569)
const norm = (s) =>
  String(s ?? "")
    .toUpperCase()
    .replace(/[()[\]]/g, " ")
