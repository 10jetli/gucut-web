  ...
  try {
    ...
    return {
      ...
      "🔎 อ่านรอบนอกตารางยังไง":
        "ถ้า `รอบนอกตารางที่ตามหลังรอบเกือบชนเพดาน` ≈ `รอบนอกตารางทั้งหมด` ⇒ เข้ากับสมมติฐาน " +
        "\"ถูกสั่งซ้ำเพราะรอบก่อนใกล้ชนเพดาน\" · ถ้าต่างกันมาก ⇒ **สมมติฐานนั้นตก ต้องหาเหตุอื่น** · " +
        "🚫 ท่อไม่สรุปสาเหตุให้ — ส่งแต่คู่ที่เทียบได้ (`รอบนอกตาราง` เก็บ 40 คู่ล่าสุด)",
      "🔎 อ่านนาทีที่เจอยังไง":
