...
//
// ---------------------------------------------------------------------------
// ⚠️ ตอนนี้ "ไม่มีหน้าไหนเรียกใช้ตัวนี้แล้ว" (26 ส.ค. 2569)
//    เจ้าของร้านสั่งให้เอาเนื้อหาหน้านโยบายเดิมออกทั้งหมด แล้วใช้ฉบับเก่าจาก Shopify แทน
//    ซึ่งไม่มีส่วนประกาศเครื่องมือวัดผลโฆษณา
//
//    ⚠️ ห้ามลบไฟล์นี้ทิ้งเพราะเห็นว่าไม่มีใครเรียก
//       มันคือส่วนที่ทำให้ประกาศตรงกับความจริงตอนเปิดพิกเซล
//       วันไหนต้องเอาส่วนนั้นกลับ ใส่ <TrackingNotice /> ในหน้านโยบายก็ใช้ได้ทันที
//       (เป็นคอมโพเนนต์ที่ไม่ถูกอ้างถึง จึงไม่ติดไปกับไฟล์ที่ส่งให้ลูกค้าอยู่แล้ว)
// ---------------------------------------------------------------------------
