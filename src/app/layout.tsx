...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="th">
      <head>
        {/*
          เปิดสายไปเซิร์ฟเวอร์ R2 ไว้ล่วงหน้า "ทุกหน้า"
          โดเมนนี้เสิร์ฟทั้งคลิปและ "รูปสินค้าทุกใบ" (ย้ายมา 25 ส.ค. 2569)
          จึงยิ่งคุ้มกว่าเดิมมาก — เดิมคุ้มเฉพาะคนที่กดเข้าหน้าวิดีโอ
          ตอนนี้ทุกคนที่เปิดหน้าไหนก็ตามได้ประโยชน์ตั้งแต่รูปใบแรก
