    ...
    import("hls.js")
      .then(({ default: Hls }) => {
        ...
        const h = new Hls({
          ...
          // เดาความเร็วเน็ตเริ่มต้นที่ ~1.5Mbps (แทนที่จะเริ่มมองว่าเน็ตช้าสุด)
          //   ทำให้เลือกคุณภาพที่เหมาะได้ตั้งแต่ชิ้นแรก ไม่ต้องเริ่มเบลอแล้วค่อยไต่
          //   = ภาพคมตั้งแต่แรกแบบ TikTok แทนที่จะเห็นภาพแตกวูบก่อน
          abrEwmaDefaultEstimate: 1_500_000,
          // ให้ตัว ABR เลือกชั้นเริ่มต้นเองจากที่เดาเน็ตไว้ (แทนบังคับชั้นต่ำสุด)
          startLevel: -1,
