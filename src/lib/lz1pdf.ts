...
export async function buildLz1Pdf(
  ...
  // ⚠️ ช่องโทรศัพท์จริง = 341-392 (จุดไข่ปลาเริ่มตั้งแต่ 341 · ป้ายโทรสารเริ่ม 394)
  //    เคยตั้ง 356 เบอร์เลยกองชิดขวาไม่กึ่งกลาง (เจ้าของร้านวงจากใบจริง 27 ส.ค. 2569)
  fit(p1, th(d.phone), 342, 391, 563, 8);
