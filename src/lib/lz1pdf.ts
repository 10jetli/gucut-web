...
export async function buildLz1Pdf(
  ...
  // ⚠️ ช่องโทรศัพท์แคบจริงแค่ 355-392 — ป้าย "หมายเลขโทรสาร" เริ่มที่ 394
  //    (วัดพลาดรอบแรกเป็น 427 เพราะอ่านสเกลภาพซูมผิด เบอร์เลยทับป้าย
  //    เจ้าของร้านเห็นจากใบพิมพ์จริง 27 ส.ค. 2569) — fit ย่อถึง 5.5 ให้ลงช่องพอดี
  fit(p1, th(d.phone), 356, 392, 563, 8);
