 ...
 *    🔑 **สี่ตัวที่ยกมาข้างบนมีรูปเดียวกัน**: ท่อรับค่าไว้ แต่ไม่ได้ใช้ และไม่บอกว่าไม่ได้ใช้
 *       (เขียน "สี่ตัวที่ยกมา" ไม่ใช่ "ทุกตัว" — ผมเห็นสี่ตัวอย่าง ไม่ได้สำรวจทั้งระบบ
 *        คำว่า "ทุกตัว" ต้องมาจากการสำรวจ ไม่ใช่จากตัวอย่างที่บังเอิญเจอ)
 *
