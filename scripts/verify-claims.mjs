  ...
  },
  {
    ...
    async check() {
      ...
      /* 📌 **วัดฝั่ง ZORT ไว้แล้ว 7 ก.ย. 2569** — `/Warehouse/Transferlist` = **12,197 ใบ**
       ...
       ⚠️ ยังไม่รู้ว่า 195 ใบนั้นคืออะไร (ชนิดไหน ช่วงไหน) — **นี่คือตัวเลข ไม่ใช่คำอธิบาย** */
      return {
        state: "ต้องดูด้วยตา",
        why: `กระจกมี ${t.toLocaleString()} ใบ · ใบเก่าสุด ${r.body?.oldest ?? "?"} ` +
          ...
          `· วัดไว้ 7 ก.ย. 2569: ZORT 12,197 · กระจก 12,002 ⇒ **ต่าง 195 ใบ** ` +
          `— เฝ้า "ส่วนต่าง" ไม่ใช่เลขดิบ และส่วนต่างที่นิ่งก็ยังไม่ปลอดภัย`,
      };
    },
  },
  {
