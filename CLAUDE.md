...
1. **เข้าสู่ระบบด้วย LINE / Facebook — เขียนเสร็จแล้ว**
   ...
   **เพิ่มเจ้าใหม่ (เช่น Google)**: เขียน object ใน `lib/oauth.mjs` แบบเดียวกับ `LINE`/`FACEBOOK`
...
2. Google login — ยังไม่ได้ต่อ ปุ่มมีแต่หน้าตา
3. คูปอง / โค้ดส่วนลด
